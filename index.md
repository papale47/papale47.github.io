...
<a href="https://papale47-experimentation-tools-streamlit-app-akgz6j.streamlit.app/" onclick="analytics.track('Button Clicked', { 'clicked_experimentation_toolkit': 'Streamlit App Experimentation Toolkit' })">Streamlit App (Experimentation Toolkit)</a>
